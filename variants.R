...
legend <- c("D1VHU", "D1HU", "D2VHU", "D2HU", "D2U", "CVHU", "CHU", "CU", "C")
pch <- c(seq(1,5),15,16,17,18)
...
legend(120, -35, legend=legend, pch=pch, ncol=9, bty='o')
...
lines(area_l, avg_max_lat, type='o', pch=pch[8])

# C
avg_max_lat <- c(102.15, 135.46, 142.60, 137.22, 137.26, 137.65, 137.84, 136.73)
lines(area_l, avg_max_lat, type='o', pch=pch[9])
...
lines(num_FFD, avg_max_lat, type='o', pch=pch[8])

# C
avg_max_lat <- c(128.00, 129.72, 130.58, 136.56, 136.44, 140.62, 139.56, 137.27)
lines(num_FFD, avg_max_lat, type='o', pch=pch[9])
